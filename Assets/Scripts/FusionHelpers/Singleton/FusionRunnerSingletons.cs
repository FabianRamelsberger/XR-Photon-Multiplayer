...
namespace FusionHelpers
{
    ...
    {
        private static Dictionary<NetworkRunner, Dictionary<Type, object>> _singletonsByRunner =
            new Dictionary<NetworkRunner, Dictionary<Type, object>>();

        private static Dictionary<NetworkRunner, Dictionary<Type, List<Action<object>>>> _pendingRequestsByRunner =
            new Dictionary<NetworkRunner, Dictionary<Type, List<Action<object>>>>();
        ...
        public static Action<object> WaitForSingleton<T>(this NetworkRunner runner, Action<T> onSingletonResolved)
        ...
        public static void RegisterSingleton<T>(this NetworkRunner runner, Type basetype, T singleton)
            where T : MonoBehaviour
        {
        ...
        private static void RegisterSingleton<T>(NetworkRunner runner, Dictionary<Type, object> singletonsByType,
            Type singletonType, T singletonInstance) where T : MonoBehaviour
        {
